...
SUMMARY = "A small image with IRIS hub development support"
...
set_file_links() {
	...
	# Create gcc link
	ln -s /usr/bin/arm-poky-linux-gnueabi-gcc ${IMAGE_ROOTFS}/usr/bin/gcc

	# Create aclocal link
	ln -s /usr/share/aclocal-1.15 ${IMAGE_ROOTFS}/usr/share/aclocal
}
